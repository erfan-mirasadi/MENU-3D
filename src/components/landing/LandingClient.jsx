...
export default function LandingClient() {
  ...
  return (
    <main
      className={`min-h-screen bg-dark-900 text-white selection:bg-accent selection:text-white overflow-x-hidden ${isRtl ? "dir-rtl" : "dir-ltr"}`}
      dir={isRtl ? "rtl" : "ltr"}
    >
      {/* Background Ambience */}
        ...
        <section className="flex flex-col items-center text-center space-y-8 animate-fade-in-up">
          <div className="flex flex-col items-center gap-6">
            ...
            <h1 className="text-6xl md:text-8xl font-black tracking-tighter flex gap-4">
              ...
              <span className="text-accent drop-shadow-[0_0_30px_rgba(234,124,105,0.4)]">
                {t.heroTitle2}
              </span>
            </h1>
        ...
        <section className="flex flex-col gap-32 md:gap-40 w-full py-8">
          ...
          >
            <div className="flex-1 space-y-6 lg:px-10">
              <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-accent/10 text-accent font-bold text-sm tracking-wide border border-accent/20">
                <RiMagicLine /> {t.forCustomers}
              </div>
              <h2 className="text-4xl md:text-6xl font-black text-white leading-tight">
                {t.customerTitle1}{" "}
                <span className="text-transparent bg-clip-text bg-linear-to-r from-accent to-accent-soft">
                  {t.customerTitle2}
                </span>
              </h2>
              ...
              <Link
                href="/liman-coast/T-01"
                className="inline-flex items-center justify-center gap-2 px-6 py-4 rounded-xl bg-accent text-white font-bold text-lg hover:bg-accent-hover transition-all shadow-lg hover:shadow-xl hover:-translate-y-1 active:scale-95 mt-4 w-full md:w-auto"
              >
                {t.exploreDemo}{" "}
                <RiArrowRightLine
            ...
            <div className="flex-1 w-full max-w-[320px] mx-auto relative lg:mx-0">
              <div className="absolute inset-0 bg-accent blur-[100px] opacity-20 group-hover:opacity-40 transition-opacity duration-700"></div>
              <div className="relative rounded-[2.5rem] overflow-hidden border-[6px] border-dark-800 shadow-[0_30px_60px_rgba(0,0,0,0.6)] transform group-hover:-translate-y-2 transition-transform duration-500 bg-black">
                <Image
                  src="/images/menu.png"
                  alt="Customer Digital Menu 3D"
                  width={888}
                  height={1922}
          ...
          {/* WAITER APP */}
          <div
            className={`flex flex-col ${isRtl ? "lg:flex-row" : "lg:flex-row-reverse"} items-center gap-12 lg:gap-24 group`}
          >
            <div className="flex-1 space-y-6 lg:px-10">
              ...
              <Link
                ...
                className="inline-flex items-center justify-center gap-2 px-6 py-4 rounded-xl bg-emerald-500 text-white font-bold text-lg hover:bg-emerald-600 transition-all shadow-lg hover:shadow-xl hover:-translate-y-1 active:scale-95 mt-4 w-full md:w-auto"
              >
                <RiServiceLine size={22} className={isRtl ? "ml-1" : "mr-1"} />{" "}
                {t.launchWaiter}
              </Link>
            </div>
            <div className="flex-1 w-full max-w-[320px] mx-auto relative lg:mx-0">
              ...
              <div className="relative rounded-[2.5rem] overflow-hidden border-[6px] border-dark-800 shadow-[0_30px_60px_rgba(0,0,0,0.6)] transform group-hover:-translate-y-2 transition-transform duration-500 bg-black">
                <Image
                  ...
                  alt="Waiter Table Management App"
                  width={760}
                  height={1648}
                  className="w-full h-auto object-cover"
                  sizes="(max-width: 1024px) 320px, 400px"
          ...
          >
            <div className="flex-1 space-y-6 lg:px-10">
              ...
              <h2 className="text-4xl md:text-6xl font-black text-white leading-tight">
                {t.kitchenTitle1}{" "}
                <span className="text-transparent bg-clip-text bg-linear-to-r from-yellow-400 to-amber-200">
                  {t.kitchenTitle2}
                </span>
              </h2>
              <p className="text-lg md:text-xl text-gray-400 leading-relaxed">
              ...
              <Link
                href="/chef/dashboard"
                className="inline-flex items-center justify-center gap-2 px-6 py-4 rounded-xl bg-yellow-500 text-black font-bold text-lg hover:bg-yellow-400 transition-all shadow-lg shadow-yellow-500/20 hover:shadow-xl hover:-translate-y-1 active:scale-95 mt-4 w-full md:w-auto"
              >
                <RiRestaurantFill
                  size={22}
            ...
            <div className="flex-[1.5] w-full relative">
              ...
              <div className="relative rounded-2xl overflow-hidden border border-dark-600 shadow-[0_30px_60px_rgba(0,0,0,0.6)] transform group-hover:scale-[1.02] transition-transform duration-500 bg-dark-900">
                <Image
                  src="/images/chef.png"
                  alt="Chef Kitchen Display App"
                  width={3456}
                  height={1922}
                  className="w-full h-auto object-cover"
          ...
          >
            <div className="flex-1 space-y-6 lg:px-10">
              ...
              <Link
                ...
                className="inline-flex items-center justify-center gap-2 px-6 py-4 rounded-xl bg-purple-500 text-white font-bold text-lg hover:bg-purple-600 transition-all shadow-lg shadow-purple-500/20 hover:shadow-xl hover:-translate-y-1 active:scale-95 mt-4 w-full md:w-auto"
              >
                <RiBankCardLine size={22} className={isRtl ? "ml-1" : "mr-1"} />{" "}
                {t.launchCashier}
              </Link>
            </div>
            <div className="flex-[1.5] w-full relative">
          ...
          >
            <div className="flex-1 space-y-6 lg:px-10">
              ...
              <Link
                ...
                className="inline-flex items-center justify-center gap-2 px-6 py-4 rounded-xl bg-blue-500 text-white font-bold text-lg hover:bg-blue-600 transition-all shadow-lg shadow-blue-500/20 hover:shadow-xl hover:-translate-y-1 active:scale-95 mt-4 w-full md:w-auto"
              >
                <RiDashboardLine
                  size={22}
                  className={isRtl ? "ml-1" : "mr-1"}
            ...
            <div className="flex-[1.5] w-full relative">
              ...
              <div className="relative rounded-2xl overflow-hidden border border-dark-600 shadow-[0_30px_60px_rgba(0,0,0,0.6)] transform group-hover:scale-[1.02] transition-transform duration-500 bg-dark-900">
                <Image
                  ...
                  alt="Admin Analytics and Reporting Panel"
                  width={3456}
                  height={1922}
                  className="w-full h-auto object-cover"
                  sizes="(max-width: 1024px) 100vw, 60vw"
