          ...
          <button
            ...
            className={`w-full mt-4 py-4 text-white font-bold rounded-xl flex items-center justify-center gap-2 shadow-lg transition-all ${
              loading
                ...
                : features.kitchen
                  ? "bg-linear-to-r from-yellow-600 to-yellow-500 hover:from-yellow-700 hover:to-yellow-600 shadow-yellow-900/40"
                  : "bg-linear-to-r from-green-600 to-green-500 hover:from-green-700 hover:to-green-600 shadow-green-900/40"
            }`}
          >
