...
export default function DrawerFooter({ totalAmount, onCloseTable, loading }) {
  ...
  return (
    <div className="p-4 bg-dark-800 border-t border-white/5 shadow-[0_-5px_20px_rgba(0,0,0,0.3)] safe-area-bottom shrink-0">
      <div className="flex justify-between items-end mb-3">
        ...
        <span className="text-3xl font-black text-white tracking-tighter">
          ...
          <span className="text-accent text-xl">{t("currency")}</span>
        </span>
      </div>
