        ...
        <div className="lg:col-span-2 flex flex-col gap-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <StatsCard
              ...
              percentage={
                stats.revenue.trend != null
                  ? stats.revenue.trend.toFixed(2)
                  : null
              }
              isPositive={
                stats.revenue.trend != null && stats.revenue.trend >= 0
              }
            ...
            <StatsCard
              ...
              percentage={
                stats.dishes.trend != null
                  ? stats.dishes.trend.toFixed(2)
                  : null
              }
            ...
            <StatsCard
              ...
              percentage={
                stats.customers.trend != null
                  ? stats.customers.trend.toFixed(2)
                  : null
              }
              isPositive={
                stats.customers.trend != null && stats.customers.trend >= 0
              }
              icon={RiGroupLine}
              loading={loading}
            />
