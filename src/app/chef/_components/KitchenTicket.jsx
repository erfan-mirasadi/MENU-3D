...
function TicketItem({ item, onUpdateStatus, isNew }) {
  ...
  const getTitle = (product) => {
    ...
    if (typeof product.title === "object") {
      return (
        product.title[language] || product.title[fallbackLang] || "Unknown Item"
      );
    }
  ...
  return (
    ...
    >
      ...
      <div className="flex items-center gap-3">
        ...
        <div>
          <span
            className={`block font-bold text-lg leading-tight ${isServed ? "text-gray-500 line-through" : "text-gray-800"}`}
          >
