...
export default function KitchenTimer({ createdAt }) {
  ...
  if (secondsLeft < 0) {
    colorClass =
      "bg-red-100 text-red-800 border-red-300 animate-pulse border-2 shadow-red-500/50 shadow-lg"; // Overdue
  ...
  return (
    <div
      className={`flex items-center gap-2 px-3 py-1.5 rounded-lg border shadow-sm font-mono font-bold tracking-wider transition-colors duration-500 ${colorClass}`}
    >
