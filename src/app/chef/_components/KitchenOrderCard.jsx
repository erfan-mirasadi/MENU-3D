    ...
    >
      ...
      <div className="flex justify-between items-start mb-4 border-b border-gray-200 pb-3">
        <div>
          ...
          <div
            className={`text-sm font-black tracking-wider ${statusColor} flex items-center gap-1`}
          >
            {isNew && (
      ...
      <div className="grow flex flex-col justify-center items-center text-center gap-2 mb-6">
        ...
        <span className="text-2xl font-bold text-gray-700 leading-snug">
          {typeof order.products?.title === "object"
            ? order.products.title?.en ||
              order.products.title?.ru ||
              order.products.title?.tr ||
              "Unknown Item"
